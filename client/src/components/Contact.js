...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ color: "#eee" }}>Thanks for your submission!</h1>
      </div>

      <div
        className="mbr-overlay"
        style={{ opacity: "0.9", backgroundColor: "rgb(189, 224, 235)" }}
      />
            ...
            >
              ...
              <span className="input-group-btn">
                <button
                  href=""
                  type="submit"
                  className="btn btn-info btn-form display-4"
