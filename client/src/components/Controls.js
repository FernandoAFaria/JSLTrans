  ...
  return (
    <section className="my-5">
      ...
      <table id="on-hand-totals" className="my-5 ml-auto mr-auto text-left">
        ...
        <tbody>
          <tr>
            ...
            {/* vendor, field, value */}
            <td>
              <span id="edi-on-hand-outbound" />
              <button
                onClick={() => props.printOnHand("EDI", "status", "picked up")}
            ...
            <td>
              <span id="edi-inbound" />
              <button
                onClick={() => props.printOnHand("EDI", "status", "inbound")}
                className="btn btn-sm ml-3 "
              >
                view
              </button>
          ...
          <tr>
            <th>CLEAR LANE:</th>
            <td>
              <span id="clearlane-on-hand-outbound" />
              <button
                onClick={() =>
                  props.printOnHand("CLEAR LANE", "status", "picked up")
                }
                className="btn btn-sm ml-3 "
              >
                view
            ...
            <td>
              <span id="clearlane-ofd" />
            </td>
            <td>
              <span id="clearlane-inbound" />
              <button
                onClick={() =>
                  props.printOnHand("CLEAR LANE", "status", "inbound")
                }
                className="btn btn-sm ml-3 "
              >
                view
          ...
          <tr>
            <th>HERCULES:</th>
            <td>
              <span id="hercules-on-hand-outbound" />
              <button
                onClick={() =>
                  props.printOnHand("HERCULES", "status", "picked up")
                }
                className="btn btn-sm ml-3 "
              >
                view
            ...
            <td>
              <span id="hercules-ofd" />
            </td>
            <td>
              <span id="hercules-inbound" />
              <button
                onClick={() =>
                  props.printOnHand("HERCULES", "status", "inbound")
                }
                className="btn btn-sm ml-3 "
              >
                view
      ...
      >
        ...
        >
          <div className="card-header">Insert a Shipment</div>
        ...
        >
          <div className="card-header">Update a Shipment</div>
          <div className="card-body">
            <h5 className="card-title">
              Shipment delivered, brought back as an attempt, or returned?
              Update here.
            </h5>
            <p className="card-text" />
          </div>
        ...
        >
          <div className="card-header">Print a Truck Manifest</div>
          <div className="card-body">
            <h5 className="card-title">Print by Manifest Number</h5>
            <p className="card-text" />
          </div>
        </div>
        ...
        >
          <div className="card-header">Create a driver trip</div>
          <div className="card-body">
            <h5 className="card-title">Shipments Out For Delivery</h5>
            <p className="card-text" />
          </div>
        </div>
        ...
        >
          <div className="card-header">Driver Functions</div>
          <div className="card-body">
            <h5 className="card-title">Add, Remove, Update a Driver</h5>
            <p className="card-text" />
          </div>
        </div>
      </div>
