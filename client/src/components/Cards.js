    ...
    <div className="cards-section">
        <div className="mx-2 my-4 cs-card">
          ...
          <div className="card-body">
            ...
            <div style={{textAlign: 'center'}}><button onClick={window.scrollTo(0,0)} className='btn btn-warning'>Get a Quote</button></div>
          </div>
        </div>
        ...
        <div className="mx-2 my-4 cs-card">
          ...
          <div className="card-body">
            ...
            <div style={{textAlign: 'center'}}><Link to="/contact" className='btn btn-warning'>Contact Us</Link></div>
          </div>
        </div>
