    ...
    <div className="cards-section">
        <div className="mx-2 my-4 cs-card">
          ...
          <div className="card-body">
            ...
            <div className='hidden-btn' style={{textAlign: 'center'}}><button onClick={window.scrollTo(0,0)} className='btn btn-outline-primary'>Get a Quote</button></div>
          </div>
        </div>
        ...
        <div className="mx-2 my-4 cs-card">
          ...
          <div className="card-body">
            <p className="card-text font-weight-bold text-dark my-5" style={{fontSize: '1rem'}}>Need trailer rates or pallet rates?  No problem, we got you covered.  Need a scheduled pickup or same day? </p>
             <div className='hidden-btn' style={{textAlign: 'center'}}><Link to="/contact" className='btn btn-outline-primary'>Contact Us</Link></div>
          </div> 
        </div>
